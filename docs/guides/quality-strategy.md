...
| Security scanning   | Review now; future CI          | No                | The MVP has no secrets, production data, auth, real integrations, or deployed API surface yet. | Add dependency and code scanning when integrations, auth, or deployable API services enter. |
